    ...
    <Wrapper type={type} onClick={onClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      ...
      <Description>
        <Row style={{ marginBottom: '25px' }}>
          <Column size="6" alignment="flex-start">
            <Price>{displayPrice}</Price>
            <Rating />
          </Column>
          <Column size="6" alignment="flex-end" justification="center">
            <Save saved onClick={toggleFavorite}>
              {saved ? <i class="fas fa-heart" style={{ color: '#57c59b' }}></i> : <i class="far fa-heart"></i>}
            </Save>
          </Column>
        </Row>
        <Row>
